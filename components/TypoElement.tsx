...
export const THEAD = ({ children }: { children: React.ReactNode }) => <TableHead>{children}</TableHead>
export const TBODY = ({ children }: { children: React.ReactNode }) => <TableBody>{children}</TableBody>
export const TR = ({ children }: { children: React.ReactNode }) => <TableRow>{children}</TableRow>
export const TH = ({ children }: { children: React.ReactNode }) => <TableCell>{children}</TableCell>
export const TD = ({ children }: { children: React.ReactNode }) => <TableCell>{children}</TableCell>
